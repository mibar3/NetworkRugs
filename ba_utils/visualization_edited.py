...
def draw_rug_from_graphs(graphs_data, ordering, color_encoding='id', colormap='turbo',
    ...
    # had to replace in order to create visualization matrix
    if ax is None:
    ...
    '''
    # Had to replace this in order to be able to create a matrix with all orderings and color encodings
